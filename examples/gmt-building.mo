...
model building
  ...
  extends PartialBuilding(
        redeclare package Medium = MediumW,  have_fan=false,        have_eleHea=false,  have_eleCoo=false);
  ...
  Buildings.Applications.DHC.Loads.Examples.BaseClasses.FanCoil4PipeHeatPorts
    ...
    each mLoaHea_flow_nominal=5,    each mLoaCoo_flow_nominal=5) "Terminal unit"
...
equation
  ...
  connect(weaBus, meeting.weaBus)
      annotation (
        Line(points={{1,300},{0,300},{0,20},{-66,20},{-66,-10.2},{-96,-10.2}}, color={255,204,51},thickness=0.5),
